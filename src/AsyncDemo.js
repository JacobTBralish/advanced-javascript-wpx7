...
//     }
    ...
    //USING ASYNC FORCES THE FUNCTION TO RETURN A PROMISE, MUST USE .THEN TO PULL OUT DATA OR VALUE
    async makeData() {
        return 'hello'
    }

    doThing(){
        const myString = this.makeData();
...
render(){
    return(
        /* //This is a fragment and allows for, you can do a fragment one of two ways */
        <>
        <h1>AsyncDemo</h1>
